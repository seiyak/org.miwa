 ...
 *
 */
public class RenameGetMethodEngine extends RenameMethodEngine {

	private String oldFieldName;
	private String newFieldName;
	private IJavaBeanFieldNameConvention nameConvention;

	public RenameGetMethodEngine(Refactoring refactoring,
			IJavaBeanFieldNameConvention nameConvention) {
		super(refactoring);
		this.nameConvention = nameConvention;
	}

	public RenameGetMethodEngine(Refactoring refactoring, String oldFieldName,
	...
	protected ClassGen refactor(ClassGen classGen) {
		...
		List<String> oldMethodNames = this.getMethodsWith(METHOD_PREFIX_GET,
		...
		this.setNewMethodName(METHOD_PREFIX_GET
